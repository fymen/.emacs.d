...
** page
   #+BEGIN_SRC emacs-lisp
     ...
     (setq op/theme-root-directory "~/.emacs.d/")
     (setq op/theme 'my-wy)

     (setq op/personal-disqus-shortname "fymen") 
     ;;(setq op/personal-duoshuo-shortname "fymen")
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq blog-admin-backend-nikola-executable "nikola")
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq httpd-root "/home/oscar/gitest/webtest/")
#+END_SRC
** web-mode
#+BEGIN_SRC emacs-lisp
