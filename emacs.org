...
(use-package popweb-dict
  :load-path "~/.emacs.d/extension/popweb/extension/dict"
  :bind ("C-c d" . popweb-dict-collins-pointer)
...
#+begin_src emacs-lisp :tangle no
(use-package eaf
  :load-path "~/.emacs.d/extension/emacs-application-framework"
  :custom
